...
func main() {
	lb := loadBalance.LoadBalanceFactory(loadBalance.LbConsistent, 20)
	if err := lb.Add("http://127.0.0.1:2003/base"); err != nil {
		log.Println(err)
	}
	if err := lb.Add("http://127.0.0.1:2004/base"); err != nil {
		log.Println(err)
	}
